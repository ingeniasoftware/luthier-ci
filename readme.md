...
**Luthier-CI** is a plugin for CodeIgniter 3 that makes the development of APIs (and websites in general) more easy! For full documentation, visit the project [official website](https://luthier-ci.ingenia.me/en/help/docs) (disponible en [español](https://luthier-ci.ingenia.me/en/help/docs))
